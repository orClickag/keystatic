...
import { code2Icon } from '@orclickag/keystatic-ui/icon/icons/code2Icon';
import { fileCodeIcon } from '@orclickag/keystatic-ui/icon/icons/fileCodeIcon';
import { indentIcon } from '@orclickag/keystatic-ui/icon/icons/indentIcon';
...
import { Box, Divider, Flex } from '@orclickag/keystatic-ui/layout';
